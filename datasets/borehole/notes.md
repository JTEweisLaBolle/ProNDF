...
2. **yl1 (Low-Fidelity 1)**: Modified with Hl → 0.8·Hl, L → 1·L
3. **yl2 (Low-Fidelity 2)**: Modified with Hl → 3·Hl, L → 8·L, Tl → 0.75·Tl
4. **yl3 (Low-Fidelity 3)**: Modified with Hu → 1.1·Hu, r → 4·r, L → 3·L
5. **yl4 (Low-Fidelity 4)**: Modified with Hu → 1.05·Hu, r → 2·r, L → 2·L
